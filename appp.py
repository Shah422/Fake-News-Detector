...
Original file is located at
    https://colab.research.google.com/drive/1CVjeKngeFgAGeBw693vVf1dlEO2y7qac
"""
...
!jupyter nbconvert --to script Fake News Detector.ipynb
...
if st.button("Check"):
    ...
    # Map prediction to label strings
    label_map = {0: "Real", 1: "Fake"}
    predicted_label_str = label_map.get(prediction, "Unknown")


    st.write(f"### Prediction: {predicted_label_str}")
